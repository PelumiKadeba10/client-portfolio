  ...
  return (
    <nav className="mt-5">
      <div className="relative z-50">
        ...
        <div className="md:hidden ml-10 flex justify-center">
          <button
            onClick={toggleMenu}
          ...
          <div className="p-4 text-xl font-bold text-gray-900">TimDesigns</div>
        </div>
        ...
        {/* Desktop Menu */}
        <div className="hidden md:grid gap-2 fixed left-0 top-0 h-full w-55 bg-amber-300 justify-center shadow-lg z-30">
          {/* Logo */}
          <div className="mt-10 text-3xl font-bold text-gray-900">TimDesigns</div>

          {/* Navigation Items */}
          <div className="flex flex-col space-y-6 text-center px-4 py-8">
            {navItems.map((item) => (
              <Link
                key={item}
                to={`/${item.toLowerCase()}`}
